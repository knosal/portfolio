...
С 2016-2018 г. работал преподавателем (последних курсов) в колледже по дисциплинам: современные Web-технологии (html/css/js), компьютерная графика, сетевые технологии. Обящзанности: чтение лекций, проведение групповых/практических занятий, создание учебных планов, курсов и новых образовательных программ.

С 2019 года работаю специалистом в области безопасности информации. Обязанности: администрированием сайта организации (доработка компонентов, разработка интерфейса, обновление контента), была исправлена логика существующего веб-сайта и реализованы улучшения, которые значительно улучшили его функциональность и скорость его отладки (ушел от таблиц к flexам и gridам, добавил валидацию форм, декомпозировал html и css на компоненты и js - одна задача одна функция).

С 2023 года стажеруюсь в "Лигу А" (коммерческий аутсорс по фронтенд-разработке) компании HTML Academy, на frondend-разработчика. 

## Образование:
- `2023`   
**HTML Academy**: Фронтенд-разработчик (_13мес_)  
**HTML Academy**: Вёрстка React-компонентов (_1мес_)    
**HTML Academy**: Подготовка вёрстки для CMS (_1мес_)     
**Нетология**: Программист на JavaScript (_6мес_)  
- `2022`  
**HTML Academy**: HTML и CSS. Профессиональная вёрстка (_3мес_)
...
5. Имею опыт, понимаю принцип работы в библиотеках Swiper / Leafet
...
В дополнение к своей базе знаний я активно занимаюсь поиском новых технологий и слежу за тенденциями и достижениями отрасли. Не боюсь ответственности и умею самостоятельно принимать решения. 
